...
const Navbar = () => {
  ...
  return (
    <nav className="navbar flex flex-wrap justify-between md:items-center text-white px-10 pt-6 md:px-20">
      ...
      {showMenu ? (
        <RiMenu2Line
          size={30}
          className="md:hidden absolute right-10 top-6 transition-all duration-300 menu-icon"
          onClick={() => {
            openMenu(!menu);
